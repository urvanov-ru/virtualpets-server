...
public class PetTypeServerToSharedConverter implements Converter<ru.urvanov.virtualpets.server.domain.PetType, ru.urvanov.virtualpets.shared.domain.PetType> {

    @Override
    public ru.urvanov.virtualpets.shared.domain.PetType convert(
            ru.urvanov.virtualpets.server.domain.PetType arg0) {
        switch (arg0) {
        case CAT:
